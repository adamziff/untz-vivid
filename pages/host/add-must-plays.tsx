...
//   const accessCode = '0';
  ...
  async function handleSubmitSongs() {
    ...
    setIsLoading(true)
    const response = await fetch("/api/add-must-plays", {
      method: "POST",
      headers: {
      ...
      <Layout>
          ...
          <div className={styles.newuntz}>
              {name ? 
                ...
                <div className="py-5">
                  <p className='text-blue-300 text-xl'> pick songs that you want to play at the event </p>
                </div>
              
                <h2 className="text-emerald-300 text-lg md:text-3xl font-bold">must plays</h2>
