  ...
  res: NextApiResponse<Data>
    ...
    try {
        ...
        if (!party || party.name === null) {
            res.status(500).json({ data: 'Internal server error: party not found' });
            return
        }
